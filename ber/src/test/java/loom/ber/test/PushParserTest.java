...
import loom.ber.DerPushParser;

public final class PushParserTest
{
	@Test
	public void rsa_f4_1024_p8__full () throws Exception
	{
		// prepare
		...
		try (var stream = PushParserTest.class.getResourceAsStream("/rsa_f4_1024.p8"))
		{
	...
	@Test
	public void rsa_f4_1024_p8__smallest () throws Exception
	{
		// prepare
		...
		try (var source = PushParserTest.class.getResourceAsStream("/rsa_f4_1024.p8"))
		{
